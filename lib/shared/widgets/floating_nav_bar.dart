                ...
                children: [
                  AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected && isDark 
                          ? AppColors.primary.withOpacity(0.0) // No background, just icon color change in Aura wireframe
                          : Colors.transparent,
                      borderRadius: BorderRadius.circular(12),
                    ),
                    child: IconTheme(
                  ...
                  Text(
                    ...
                    style: theme.textTheme.labelSmall?.copyWith(
                      color: isSelected 
                          ? (isDark ? Colors.white : AppColors.lightTextPrimary) // Selected text is white/dark
                          : (isDark ? AppColors.darkTextSecondary : AppColors.lightTextSecondary),
